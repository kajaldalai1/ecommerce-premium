  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome to LUXE. Your account has been created.",
      })
      router.push("/")
    }, 1500)
  }
      ...
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          <Link href="/" className="flex items-center space-x-2 mb-8">
            ...
            <span className="font-semibold text-2xl tracking-wide">LUXE</span>
          </Link>
          <h1 className="text-2xl font-bold">Create an account</h1>
          <p className="text-muted-foreground mt-2">Join LUXE for a premium shopping experience</p>
        </div>
